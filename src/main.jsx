    ...
    <div className="site-shell">
      ...
      <main id="top" className="home-main">
        ...
        <section className="section content-wrap why-section" id="why">
          ...
          <div className="split-heading"><h2>The schema lives<br /><em>in the models.</em></h2><p>Most migration workflows describe the schema twice (once in the models, once in the migration scripts), and the two drift unless someone keeps reconciling them. The disagreement usually turns up in production.<br /><br />dbwarden derives the scripts from the models. There's one definition to maintain, and the generated SQL is easy to review and safe to delete.</p></div>
