...
const translations = {
  en: {
    ...
    footer: {
      tagline: 'Declarative schema compiler for SQLAlchemy.',
      toolScope: 'Tool scope',
    ...
    home: {
      hero: {
        titleLine1: 'Your models are the source code.',
        titleLine2: 'SQL is the output.',
        subtitle: 'A declarative schema compiler for SQLAlchemy.',
        kicker: 'declarative schema compiler',
        kickerSpan: 'for SQLAlchemy',
        lede: 'dbwarden compiles SQLAlchemy models into reviewable SQL migrations. Your models are the source code. The generated SQL is the output. Upgrade, rollback, safety analysis, and schema verification come built in. Fully open source.',
      ...
      why: {
        ...
        declarativeStrong: 'You declare the target.',
        declarativeText: 'SQLAlchemy models describe what the schema should be. dbwarden compiles the migration SQL, the rollback, and the checks from that one definition.',
        imperativeLabel: 'imperative',
        imperativeStrong: 'You write every instruction.',
  ...
  es: {
    ...
    footer: {
      tagline: 'Compilador declarativo de esquemas para SQLAlchemy.',
      toolScope: 'Alcance de la herramienta',
    ...
    home: {
      hero: {
        titleLine1: 'Tus modelos son el código fuente.',
        titleLine2: 'SQL es el resultado.',
        subtitle: 'Un compilador declarativo de esquemas para SQLAlchemy.',
        kicker: 'compilador declarativo de esquemas',
        kickerSpan: 'para SQLAlchemy',
        lede: 'dbwarden compila modelos SQLAlchemy en migraciones SQL revisables. Tus modelos son el código fuente. El SQL generado es el resultado. Actualización, rollback, análisis de seguridad y verificación de esquema incluidos. Totalmente open source.',
      ...
      why: {
        ...
        declarativeStrong: 'Tú declaras el objetivo.',
        declarativeText: 'Los modelos SQLAlchemy describen cómo debería ser el esquema. dbwarden compila el SQL de migración, el rollback y las verificaciones a partir de esa única definición.',
        imperativeLabel: 'imperativo',
        imperativeStrong: 'Tú escribes cada instrucción.',
  ...
  fr: {
    ...
    footer: {
      tagline: 'Compilateur déclaratif de schémas pour SQLAlchemy.',
      toolScope: 'Périmètre de l\'outil',
    ...
    home: {
      hero: {
        titleLine1: 'Vos modèles sont le code source.',
        titleLine2: 'SQL est le résultat.',
        subtitle: 'Un compilateur déclaratif de schémas pour SQLAlchemy.',
        kicker: 'compilateur déclaratif de schémas',
        kickerSpan: 'pour SQLAlchemy',
        lede: 'dbwarden compile les modèles SQLAlchemy en migrations SQL révisables. Vos modèles sont le code source. Le SQL généré est le résultat. Mise à jour, rollback, analyse de sécurité et vérification de schéma inclus. Entièrement open source.',
      ...
      why: {
        ...
        declarativeStrong: 'Vous déclarez la cible.',
        declarativeText: 'Les modèles SQLAlchemy décrivent ce que le schéma devrait être. dbwarden compile le SQL de migration, le rollback et les vérifications à partir de cette seule définition.',
        imperativeLabel: 'impératif',
        imperativeStrong: 'Vous écrivez chaque instruction.',
  ...
  pt: {
    ...
    footer: {
      tagline: 'Compilador declarativo de schemas para SQLAlchemy.',
      toolScope: 'Escopo da ferramenta',
    ...
    home: {
      hero: {
        titleLine1: 'Seus modelos são o código fonte.',
        titleLine2: 'SQL é o resultado.',
        subtitle: 'Um compilador declarativo de schemas para SQLAlchemy.',
        kicker: 'compilador declarativo de schemas',
        kickerSpan: 'para SQLAlchemy',
        lede: 'O dbwarden compila modelos SQLAlchemy em migrações SQL revisáveis. Seus modelos são o código fonte. O SQL gerado é o resultado. Atualização, rollback, análise de segurança e verificação de schema incluídos. Totalmente open source.',
      ...
      why: {
        ...
        declarativeLabel: 'declarativo',
        declarativeStrong: 'Você declara o alvo.',
        declarativeText: 'Os modelos SQLAlchemy descrevem como o schema deve ser. O dbwarden compila o SQL de migração, o rollback e as verificações a partir dessa única definição.',
        imperativeLabel: 'imperativo',
        imperativeStrong: 'Você escreve cada instrução.',
