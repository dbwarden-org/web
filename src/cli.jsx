...
const groups = [
  ...
  { label: 'lock and merge', description: '`lock-status`, `unlock`, `merge`, `rebase`, `reconcile`, and plugin management', example: '$ dbwarden merge --database primary' },
...
export function CliPage({ dark, toggleTheme }) {
  return <PageFrame dark={dark} toggleTheme={toggleTheme} eyebrow="cli reference" title={<>dbwarden CLI<br /><em>Reference.</em></>} intro="Author, operate, inspect, lock, and reconcile migrations from one CLI. The daily loop is a few commands; the rest of the surface is there when a deployment or Git merge needs it.">
